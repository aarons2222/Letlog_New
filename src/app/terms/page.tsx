    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            Welcome to LetLog ("we", "our", "us"). These Terms of Service ("Terms") govern your use
            of our property management platform and services (the "Service") operated by LetLog.
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>"Landlord"</strong> means a user who owns or manages rental properties
            </li>
            <li>
              <strong>"Tenant"</strong> means a user who rents a property managed through our
              Service
            </li>
            <li>
              <strong>"Contractor"</strong> means a user who provides maintenance or repair services
            </li>
            <li>
              <strong>"Property"</strong> means any residential or commercial property managed
              through the Service
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Not contact property owners or tenants outside of the platform for unsolicited
              marketing
            </li>
          </ul>
          ...
          <p>
            Some features of the Service require a paid subscription. Subscription fees are billed
            in advance on a monthly basis and are non-refundable except as required by law.
          </p>
          <p>
            We reserve the right to change our fees upon 30 days' notice. Continued use of the
            Service after a fee change constitutes acceptance of the new fees.
          </p>

          <h2>9. Intellectual Property</h2>
          <p>
            The Service and its original content, features, and functionality are owned by LetLog
            and are protected by international copyright, trademark, and other intellectual property
            laws.
          </p>
          <p>
            You retain ownership of any content you upload to the Service, but grant us a licence to
            use, store, and display that content as necessary to provide the Service.
          </p>

          <h2>10. Limitation of Liability</h2>
          <p>
            LetLog is a software platform that facilitates property management. We are not a party
            to any agreements between landlords, tenants, or contractors, and we do not guarantee
            the actions or conduct of any user.
          </p>
          <p>
            To the maximum extent permitted by law, LetLog shall not be liable for any indirect,
          ...
          <p>
            We do not provide legal, tax, or financial advice. You should consult appropriate
        ...
        <div className="mt-16 pt-8 border-t border-slate-200">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/privacy" className="text-[#E8998D] hover:text-[#C17B6E] font-medium">
              Privacy Policy
            </Link>
