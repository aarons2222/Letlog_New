      ...
      <main className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            ...
            functionality such as security, account access, and remembering your preferences. You
          ...
          <ul>
            ...
            <li>
              <strong>Google Analytics:</strong> For website analytics (if enabled)
            </li>
            <li>
          ...
          <p>
            When you first visit our website, you will be shown a cookie banner asking for your
