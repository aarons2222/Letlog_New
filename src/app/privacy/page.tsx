    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            LetLog ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy
          ...
          <ul>
            ...
            <li>
              <strong>Account Data:</strong> Username, password, account preferences
            </li>
            <li>
              <strong>Property Data:</strong> Property addresses, tenancy details, rent amounts
            </li>
            <li>
              <strong>Financial Data:</strong> Payment card details, bank account information
              (processed securely via Stripe)
            </li>
            <li>
              <strong>Technical Data:</strong> IP address, browser type, device information, login
              data
            </li>
            <li>
          ...
          <p>
            We do not intentionally collect special category data (such as racial or ethnic origin,
            health data, etc.). Please do not include such information in any documents or
            communications you upload to the Service.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Consent:</strong> Where you have given consent for specific processing
            </li>
            <li>
              <strong>Legal Obligation:</strong> Processing necessary to comply with the law
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Other Users:</strong> Landlords, tenants, and contractors as necessary to
              provide the Service (e.g., sharing tenant contact details with approved contractors
              for repairs)
            </li>
            <li>
            ...
            <li>
              <strong>Professional Advisers:</strong> Lawyers, accountants, and insurers where
              necessary
            </li>
            <li>
              <strong>Law Enforcement:</strong> Where required by law or to protect our rights
            </li>
          </ul>
          ...
          <p>
            ...
            to provide the Service. We may retain certain information as required by law or for
          ...
          <ul>
            ...
            <li>
              <strong>Erasure:</strong> Request deletion of your information ("right to be
              forgotten")
            </li>
            <li>
          ...
          <p>To exercise these rights, please contact us at privacy@letlog.co.uk.</p>

          <h2>9. International Transfers</h2>
          <p>
            Your information may be transferred to and processed in countries outside the UK. Where
            this happens, we ensure appropriate safeguards are in place, such as Standard
          ...
          <h2>14. Complaints</h2>
          <p>
            If you are not satisfied with how we handle your personal information, you have the
        ...
        <div className="mt-16 pt-8 border-t border-slate-200">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/terms" className="text-[#E8998D] hover:text-[#C17B6E] font-medium">
              Terms of Service
            </Link>
            <Link href="/cookies" className="text-[#E8998D] hover:text-[#C17B6E] font-medium">
              Cookie Policy
            </Link>
          </div>
        </div>
